...
| Multiple line code | \`\`\` <br /> name-of-the-language <br /> Code line 1 <br /> Code line 2 <br /> \`\`\` <br /> Syntax highlighting is possible by specifying the name of the language as a part of first line|  \`\`\` <br />javascript <br /> var first \= 1 \; <br /> var second \= 2 \; <br /> \`\`\` | 
